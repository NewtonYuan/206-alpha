...
public class GameOver implements GameState {
    ...
    public void handleRectangleClick(MouseEvent event, String rectangleId) throws IOException {
        ...
        roomController.setTitleLabelText("Game Over, you have already guessed! This is"
                + (suspectResult == "innocent" ? " not" : "") + " the thief");
        TextToSpeech.speak("Game Over, you have already guessed! This is" + (suspectResult == "innocent" ? " not" : "")
                + " the thief");
    }
